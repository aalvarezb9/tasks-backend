...
exports.router.post('/', [(0, express_validator_1.body)('name').isString().notEmpty(), ValidationMiddleware_1.validationMiddleware], CategoryController_1.CategoryController.create.bind(CategoryController_1.CategoryController));
