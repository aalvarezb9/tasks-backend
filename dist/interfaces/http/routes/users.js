...
exports.router.get(
  '/',
  [(0, express_validator_1.query)('email').isEmail(), ValidationMiddleware_1.validationMiddleware],
  UserController_1.UserController.find.bind(UserController_1.UserController)
);
exports.router.post(
  '/',
  [
